...
@InputType()
class ProductSupplyCreateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => SupplyTrackCreateNestedManyWithoutProductSuppliesInput,
  })
  @ValidateNested()
  @Type(() => SupplyTrackCreateNestedManyWithoutProductSuppliesInput)
  @IsOptional()
  @Field(() => SupplyTrackCreateNestedManyWithoutProductSuppliesInput, {
    nullable: true,
  })
  supplyTracks?: SupplyTrackCreateNestedManyWithoutProductSuppliesInput;
}
export { ProductSupplyCreateInput };
