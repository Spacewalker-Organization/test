...
export class OrderTrackControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: OrderTrack })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: OrderTrackCreateInput
  ): Promise<OrderTrack> {
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [OrderTrack] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(OrderTrackFindManyArgs)
  async findMany(@common.Req() request: Request): Promise<OrderTrack[]> {
    const args = plainToClass(OrderTrackFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: OrderTrackWhereUniqueInput
  ...
  async update(
    @common.Param() params: OrderTrackWhereUniqueInput,
    @common.Body() data: OrderTrackUpdateInput
  ): Promise<OrderTrack | null> {
    try {
